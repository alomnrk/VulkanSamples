#include "TransfusionRenderSystem.h"
...
namespace lwmeta {
    ...
    void TransfusionRenderSystem::createPipelineLayout(VkDescriptorSetLayout globalSetLayout,
    ...
    void TransfusionRenderSystem::createPipeline(VkRenderPass renderPass) {
        ...
        pipeline = std::make_unique<Pipeline>(
                ...
                "shaders/noise.frag.spv",
                pipelineConfig);
    }

    void TransfusionRenderSystem::renderGameObjects(FrameInfo &frameInfo, GameObject::Map &gameObjects) {
